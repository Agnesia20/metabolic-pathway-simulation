"""
BISB211605 - Systems Biology Final Exam
Q2C - Simulation of the 4-reaction branch-point pathway
with allosteric (non-competitive) feedback inhibition of P on v1
...
System:
    ...
    P exerts non-competitive allosteric inhibition on v1

Author: (Alya Nurma Walyati)
"""
